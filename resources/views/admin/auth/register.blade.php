...
@section('content')
<div
    style="min-height: 100vh; display: flex; align-items: center; justify-content: center; background: linear-gradient(135deg, #667eea 0%, #4b5563 100%); padding: 20px;">
    <div style="width: 100%; max-width: 420px;">
        ...
        <!-- Card -->
        <div
            style="background: white; border-radius: 12px; box-shadow: 0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04); padding: 40px; margin-bottom: 20px;">
            @if ($errors->any())
            <div
                style="background-color: #fee2e2; border: 1px solid #fca5a5; color: #991b1b; padding: 12px 16px; border-radius: 8px; margin-bottom: 20px; font-size: 14px;">
            ...
            <form method="POST" action="{{ url('/admin/register') }}" novalidate>
                ...
                <div style="margin-bottom: 20px;">
                    <label for="name"
                        style="display: block; font-size: 14px; font-weight: 500; color: #1f2937; margin-bottom: 8px;">Full
                        Name</label>
                ...
                <div style="margin-bottom: 20px;">
                    <label for="email"
                        style="display: block; font-size: 14px; font-weight: 500; color: #1f2937; margin-bottom: 8px;">Email
                        Address</label>
                ...
                <div style="margin-bottom: 20px;">
                    <label for="password"
                        style="display: block; font-size: 14px; font-weight: 500; color: #1f2937; margin-bottom: 8px;">Password</label>
                    ...
                    @else
                    <p style="color: #6b7280; font-size: 12px; margin-top: 4px;">Use uppercase, lowercase, numbers, and
                        symbols</p>
                    @endif
                </div>
                ...
                <div style="margin-bottom: 24px;">
                    <label for="password_confirmation"
                        style="display: block; font-size: 14px; font-weight: 500; color: #1f2937; margin-bottom: 8px;">Confirm
                        Password</label>
                ...
                <!-- Submit -->
                <button type="submit"
                    style="width: 100%; padding: 10px 16px; background: linear-gradient(135deg, #3047af 0%, #4b5563 100%); color: white; font-size: 14px; font-weight: 600; border: none; border-radius: 8px; cursor: pointer; transition: opacity 0.2s;"
        ...
        <p style="text-align: center; color: white; font-size: 14px;">
            Already have an account? <a href="{{ url('/admin/login') }}"
                style="color: #ebebeb; text-decoration: none; font-weight: 600;">Sign in</a>
        </p>
    </div>
</div>
@endsection